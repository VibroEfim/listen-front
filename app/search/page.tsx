...
export default function Search() {
  const songExample = {
    id: 0,
    name: "невоспитанная красота 2",
    author: "ефим",
    views: 14,
    uploader: "TheCreeeZ",
    uploaded: "12.12.12 10:23",
    url: "/path/test.mp3",
  }
  ...
  return (
    <Box margin = {6} height={"100%"}>
      ...
      <Box color={"yellow"} margin={1}>
        To-do: Добавлять чето в поиск ютюба чтоб выводило только песни (По хорошему AutoGenerated)
      </Box>
      {
        isSearching
